...
namespace tilia
{
	...
	namespace monitoring
	{
		...
		namespace properties
		{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Resolution>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Bit_Depths>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Refresh_Rate>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Supported_Resolutions>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Supported_Bit_Depths>
			{
				using Get_Parameters = 
					std::vector<std::tuple<std::uint32_t, std::uint32_t, std::uint32_t>>;
				using Get_Arguments = 
					Monitor_Property<enums::Property::Resolution>::Get_Parameters;
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Supported_Refresh_Rates>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Physical_Size>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Content_Scale>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Virtual_Position>
			{
				using Get_Parameters = std::pair<std::int32_t, std::int32_t>;
				static Get_Parameters Get(Monitor& monitor);
			};
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Workarea>
			{
				using Get_Parameters = 
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Name>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Gamma_Ramp>
			{
			 ...
			 */
			template<>
			struct Monitor_Property<enums::Property::Gamma>
			{
		...
		public:
			 ...
			 */
			template<>
			auto Get<enums::Property::Underlying_Monitor>()
			{
				return m_monitor;
			}
